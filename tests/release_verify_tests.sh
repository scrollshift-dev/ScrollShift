...
# cases the existing-release verification must reject. No network or privileges
# are required; the archives are small fixture files.
...
# Unexpected extra asset in the set is rejected.
printf 'stray' > "$root/unexpected.txt"
expect_fail "unexpected asset present"
